...
assert(direction == 1 || direction == -1, 'KroneckerBio:accumulateSol', 'direction must be 1 (forward) or -1 (reverse)');
...
%simOpts = odeset('Jacobian', jac, 'AbsTol', AbsTol, 'RelTol', RelTol);
if ~isempty(events)
