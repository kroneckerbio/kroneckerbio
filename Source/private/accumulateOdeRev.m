function cum_sol = accumulateOdeRev(der, jac, t0, tF, ic, u, discontinuities, nonnegative, RelTol, AbsTol, delta, events, t_first_event, n_events)
...
for k = 1:(N-1)
    ...
    while t_event_start > t_event_end && ne < n_events && n_false_events < max_false_events
        ...
        cum_sol = mergeSolsRev(cum_sol, sim_sol);
